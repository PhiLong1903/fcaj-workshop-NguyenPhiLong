...
* Create an AWS account. Doing 5 task to get 200$.
...
* Successfully registered and used an AWS account.
* Able to use the AWS Management interface.
* Understand the company rules.
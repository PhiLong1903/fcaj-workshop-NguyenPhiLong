...
* Xây dựng lớp frontend với S3, Cloudfront và WAF.
* Tiếp tục xây dựng project nhóm.
...
* Đã xây dựng được frontend tích hợp S3
* Xây dựng các chức năng cho project nhóm: UI AI Interview và các chức năng liên quan tới interview.

...
* Study the theories and practice lab exercises related to AWS RDS.
* Gain a general understanding of how to draw AWS architecture for a team project.
...
* Gained basic knowledge of AWS RDS.
* Implemented backup, data security, and database management system deployment in a cloud environment.
* Design the basic architecture for the team project (including frontend layer, VPC, Private/Public subnet, AI processing layer, SNS, SES).

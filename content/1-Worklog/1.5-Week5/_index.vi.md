...
* Nghiên cứu các lý thuyết và thực hành bài lab liên quan tới AWS RDS.
* Tìm hiểu tổng quát về cách vẽ kiến trúc aws cho dự án nhóm.
...
* Nắm được kiến thức cơ bản về AWS RDS.
* Thực hiện triển khai backup, bảo mật data, hệ quản trị data trên môi trường cloud.
* Thiệt kế được kiến trúc cơ bản cho project nhóm ( gồm có lớp frontend, VPC, Private/Public subnet, lớp xử lý AI, SNS, SES)

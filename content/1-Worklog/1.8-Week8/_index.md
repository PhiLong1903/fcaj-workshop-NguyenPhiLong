...
* Learn about S3, WAF, and CloudFront to understand the architectural design (frontend layer) and deployment for the team project.
* Continue building the UI for the team project.
...
* Basic understanding of WAF, S3, and Cloudfront deployments
* Able to draw the frontend layer in the architecture
* Completed several interfaces for the team project.
* Able to use Cognito for signin and signup functionality.